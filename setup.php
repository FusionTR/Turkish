...
$locale['setup_0006'] = "PHP-Fusion 9 Kurulabilmesi için Enaz PHP 5.5.9 Gerektirir. Daha Fazla Bilgi için <a href=\"https://www.php-fusion.co.uk/requirements\"> Sistem Gereksinimleri </a> Sayfasına Bakınız.";
...
$locale['setup_0115'] = "Etkin";
$locale['setup_0115a'] = "Etkin Değil";
$locale['setup_0116'] = "PHP OPcode Önbellekleme, Sitenizin Performansını Önemli Ölçüde Artırabilir. <a href='http://php.net/manual/opcache.installation.php' target='_blank'>OPcache</a>'in Sunucunuza <strong>Yüklenmesi Önerilir</strong>.";
$locale['setup_0118'] = "Web Sunucunuz PDOyu (PHP Data Objects) Desteklemiyor Gibi Görünüyor. Barındırma Sağlayıcınıza Sunucunuzun PDO Uzantısını Destekleyip Desteklemeğini Sorun.";
...
$locale['setup_0134'] = "Tüm Dosyalar Yazılabilirlik Gereksinimlerini Geçti";
$locale['setup_0135'] = "Kurulumun Devam Edebilmek İçin Aşağıdaki Dosyalar ve Klasörler Yazılabilir Olmalıdır. Devam Etmek İçin Dosyaların CHMOD Ayarlarını 755 veya 777 Olarak Düzenleyin.";
$locale['setup_0136'] = "Yazılabilir Değil (Başarısız)";
$locale['setup_0137'] = "Yazılabilir (Başarılı)";
$locale['setup_0138'] = "Veritabanı Bağlantısı Kuruldu";
$locale['setup_0139'] = "Database column selection established";
$locale['setup_0140'] = "Veritabanı Mevcut ve Kuruluma Hazır";
$locale['setup_0141'] = "Veritabanı İzinleri ve Erişim Doğrulandı";
...
$locale['setup_1006'] = "LÜTFEN CONFIG.PHP YEDEKLEYİNİZ. KALDIRMA SIRASINDA SİSTEMDEN SİLİNECEK.";
$locale['setup_1007'] = "Kaldır ve Tekrar Başla";
$locale['setup_1008'] = "Çekirdek Sistem Yükleyicisi";
$locale['setup_1009'] = "Çekirdek Sistem Yapılandırmasını Değiştirin.";
$locale['setup_1010'] = "Sistem Yükleyicisine Git";
$locale['setup_1011'] = "Birincil Hesap Ayrıntılarını Değiştir";
$locale['setup_1012'] = "Şifreyi Kurtarmanız veya SA Hesabının Sahipliğini Başka Bir Hesaba Aktarmanız Gerekmeden, Süper Yönetici Ayrıntılarını Değiştirme.";
...
$locale['setup_1202'] = "Veritabanı Sunucu Adı:";
$locale['setup_1203'] = "Veritabanı Kullanıcı Adı:";
$locale['setup_1204'] = "Veritabanı Parola:";
...
$locale['setup_1213'] = "Detaylı Site Bilgileri";
...
$locale['setup_1507'] = "Yönetim Şifresi:";
$locale['setup_1508'] = "Yönetim Şifresini Tekrarlayınız:";
$locale['setup_1509'] = "E-Posta Adresi:";
$locale['setup_1510'] = "Web Sitesi E-Posta Adresi:";
...
$locale['setup_3021'] = "PHP BilgisiS";
...
$locale['setup_3203'] = "S.S.S.";
$locale['setup_3204'] = "Forumlar";
$locale['setup_3205'] = "Haberler";
$locale['setup_3206'] = "Resim Galerisi";
$locale['setup_3207'] = "Anketler";
$locale['setup_3208'] = "E-Posta Şablonları";
$locale['setup_3209'] = "Web Linkleri";
$locale['setup_3210'] = "Sitelinkleri";
...
$locale['setup_3310'] = "Link Gönder";
$locale['setup_3311'] = "Haber Gönder";
$locale['setup_3312'] = "Makale Gönder";
$locale['setup_3313'] = "Resim Gönder";
$locale['setup_3314'] = "Dosya Gönder";
$locale['setup_3315'] = "Öneriler";
$locale['setup_3316'] = "Kısa Mesajlar";
$locale['setup_3317'] = "Blog Gönder";
$locale['setup_3318'] = "Blog Arşiv Paneli";
$locale['setup_3319'] = "Son Tartışmalar";
$locale['setup_3320'] = "Katılınan Tartışmalar";
$locale['setup_3321'] = "Takip Edilen Konular";
...
$locale['setup_3505'] = "Günlük";
$locale['setup_3506'] = "&#220;yeler";
$locale['setup_3507'] = "Eklentiler";
$locale['setup_3508'] = "Filmler";
$locale['setup_3509'] = "Network";
$locale['setup_3510'] = "Haberler";
...
$locale['setup_3603'] = "Yeni Üye";
$locale['setup_3604'] = "Acemi Üye";
...
$locale['setup_3802'] = "Yeni Bir Mesajınız Var. [USER] Tarafından Gönderilen Mesajı Sitemiz Olan [SITENAME] e Giriş Yapıp Okuyabilirsiniz.";
$locale['setup_3803'] = "Merhaba [RECEIVER],\r\nSitemiz [SITENAME] Üyelerinden [USER] Size [SUBJECT] Başlıklı Yeni Bir Özel Mesaj gönderdi. Özel Mesajlarınızı Görüntülemek İçin [SITEURL]messages.php Adresine Tıklayın\r\n\r\nMesaj: [MESSAGE]\r\n\r\nE-Posta Bildirimini Özel Mesaj Sayfasındaki Bildirim Ayarlarından Kapatabilirsiniz.\r\n\r\nSaygılarımızla,\r\n[SENDER].";
$locale['setup_3804'] = "Yeni Forum MEsajı Bildirimi";
$locale['setup_3805'] = "Forum Başlığına Yeni Mesaj Gönderildi - [SUBJECT]";
$locale['setup_3806'] = "Merhaba [RECEIVER],\r\n\r\nTakip Ettiğiniz \'[SUBJECT]\' İsimli Başlığa Sitemiz [SITENAME] Üyelerinden Bir Mesaj Geldi. Aşağıdaki Linki Takip Ederek Mesaja Erişebilirsiniz:\r\n\r\n[THREAD_URL]\r\n\r\nEğer Bu Başlıktan Daha Fazla Bildirim Almak İstemiyorsanız Başlığın Seçeneklerinden \'Bu Başlığı Takip Etmeyi Durdur\' Linkine Tıklamalısınız.\r\n\r\nSaygılarımızla,\r\n[SENDER].";
...
$locale['downloads']['title'] = "İndirmeler";
$locale['downloads']['description'] = "Standart İndirme Sistemi.";
$locale['faqs']['title'] = "S.S.S.";
$locale['faqs']['description'] = "Bilgi Bankası SSS Sistemi.";
$locale['forums']['title'] = "Forum";
$locale['forums']['description'] = "Bulletin Board Forum Sistemi.";
$locale['news']['title'] = "Haberler";
$locale['news']['description'] = "Haber Yayınlama Sistemi.";
$locale['photos']['title'] = "Galeri";
$locale['photos']['description'] = "Foto Galeri Yayınlama Sistemi.";
$locale['polls']['title'] = "Anketler";
$locale['polls']['description'] = "Anket ve Kullanıcı Oylama Sistemi.";
